...
require (
	github.com/liatrio/liatrio-otel-collector/extension/githubappauthextension v0.67.1
	github.com/liatrio/liatrio-otel-collector/receiver/gitproviderreceiver v0.67.1
)
