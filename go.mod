...
require (
	github.com/liatrio/liatrio-otel-collector/extension/githubappauthextension v0.69.2
	github.com/liatrio/liatrio-otel-collector/receiver/gitproviderreceiver v0.69.2
)
