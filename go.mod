...
require (
	github.com/liatrio/liatrio-otel-collector/extension/githubappauthextension v0.66.6
	github.com/liatrio/liatrio-otel-collector/receiver/gitproviderreceiver v0.66.6
)
